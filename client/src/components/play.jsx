...
const play = () => {
  ...
  return (
    <div className="bg-cwhite h-screen grid place-content-center text-center">
      ...
      <div className="font-secondary mt-14 border border-cred bg-cred py-3 rounded-full text-cwhite text-xl cursor-pointer easing hover:bg-transparent hover:text-cred" onClick={handlePlayClick}>
        Play
      </div>
      <Footer />
    </div>
